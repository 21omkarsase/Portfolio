        ...
        <div className={classes.skills}>
          ...
          <div className={classes.skills}>
            <div className={classes["info-area"]}>
              ...
              iste ducimus, quae earum mollitia tempore labore repellendus.
              Mollitia, consequuntur ipsum molestias, excepturi itaque aperiam
              quaerat corrupti ad asperiores laudantium ex!
            </div>
